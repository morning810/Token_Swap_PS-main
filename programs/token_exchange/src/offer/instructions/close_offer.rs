...
use anchor_spl::token::{self,Token,TokenAccount, Transfer}; use crate::{_main::main_state::MainState, constants::{SEED_MAIN_STATE, SEED_OFFER}, offer::offer_state::OfferState, utils::tranfer_token_from_offeror_state, error::MyError, events};
...
pub struct ACloseOffer<'info> {
    ...
    #[account(
        mut,
        // close = offeror, //BUG: create and errors on re-initialization
        seeds = [
            SEED_OFFER, 
